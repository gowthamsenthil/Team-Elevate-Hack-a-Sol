...
if player and team:
    ...
    with predictions:
        ...
        if player_type == 'Batsman':
            ...
            op.columns = ['Total Runs', 'Fours', 'Sixes', 'Strike Rate', 'Boundary %', 'Century', 'Half Century']
            ...
            op['Boundary %'] = op['Boundary %'].round(2)
            op['Century'] = (op['Century'] * 100).round(2)
            op['Half Century'] = (op['Half Century'] * 100).round(2)
